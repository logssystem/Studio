...
const CONFIG = {
  ...
  */
  ...
  DEMO_PHOTOS: [
    ...
    { categoria: 'casamento', url: 'https://drive.google.com/uc?export=view&id=1InSnfyNUyiPlERYBdTljelXuQw-77LRe', titulo: 'Casamento A&J', descricao: '' },
    { categoria: 'casamento', url: 'https://drive.google.com/uc?export=view&id=1f-5scYM482znGxEYwaTm_vYgFcw9oOUb', titulo: 'Casamento A&J', descricao: '' },
    { categoria: 'casamento', url: 'https://drive.google.com/uc?export=view&id=16_DX1EG48cK1euTojqso7fmcsrfFe3L1', titulo: 'Casamento A&J', descricao: '' },
    { categoria: 'casamento', url: 'https://drive.google.com/uc?export=view&id=1zCvJX3aW-RDrFbo0Jlb9LRGgLEKKquuD', titulo: 'Casamento A&J', descricao: '' },
    { categoria: 'casamento', url: 'https://drive.google.com/uc?export=view&id=1YT_l8VHltFM7UjrMhFAy5M60_y1Spm7n', titulo: 'Casamento A&J', descricao: '' },
    { categoria: 'casamento', url: 'https://drive.google.com/uc?export=view&id=134zAb6djuzbjKFhMyw_aTSSR9lrEdNk4', titulo: 'Casamento A&J', descricao: '' },
    { categoria: 'casamento', url: 'https://drive.google.com/uc?export=view&id=1ZoI9wSUfPUCdWaDIKZ1Q4SSL0pPH60a9', titulo: 'Casamento A&J', descricao: '' },
    { categoria: 'casamento', url: 'https://drive.google.com/uc?export=view&id=1CBofSzuNgUpmLztbbdYURw2WXn_76VK7', titulo: 'Casamento A&J', descricao: '' },
    { categoria: 'casamento', url: 'https://drive.google.com/uc?export=view&id=1ZMd0VtPBy0Ot8nativBi62bcKylBtTbu', titulo: 'Casamento A&J', descricao: '' },
    { categoria: 'casamento', url: 'https://drive.google.com/uc?export=view&id=177rptuVlNpIqmWIxHJPmjWJQXK7F6WSu', titulo: 'Casamento A&J', descricao: '' },
    { categoria: 'casamento', url: 'https://drive.google.com/uc?export=view&id=1CRtM3KKwitREGYH2IWSLiVnhh9pagIUL', titulo: 'Casamento A&J', descricao: '' },
    { categoria: 'casamento', url: 'https://drive.google.com/uc?export=view&id=1zoCaWbIF7y_33ePevUEiXy_tGGFYsSkT', titulo: 'Casamento A&J', descricao: '' },
    { categoria: 'casamento', url: 'https://drive.google.com/uc?export=view&id=1qBxDSpxXAI1FI1hrDDjdhAmdPulR6IhU', titulo: 'Casamento A&J', descricao: '' },
    { categoria: 'casamento', url: 'https://drive.google.com/uc?export=view&id=1K5xGJ29N8S1luHGv8PKSIHVmBMAetAMj', titulo: 'Casamento A&J', descricao: '' },
    { categoria: 'casamento', url: 'https://drive.google.com/uc?export=view&id=1VH0CqxHEjuSeazl5eaGF-u6C-9bSPgoq', titulo: 'Casamento A&J', descricao: '' },
    { categoria: 'casamento', url: 'https://drive.google.com/uc?export=view&id=1eZpUl_nGNgUyNAzddefd_-QAzVR2vHwT', titulo: 'Casamento A&J', descricao: '' },
    { categoria: 'casamento', url: 'https://drive.google.com/uc?export=view&id=1i2lhS1ODkFOPSCSCgADzRwHXW89yZOme', titulo: 'Casamento A&J', descricao: '' },
    { categoria: 'casamento', url: 'https://drive.google.com/uc?export=view&id=1m3DD4ip_efYcN5qRsZyJ8mIg1nJ-8R0C', titulo: 'Casamento A&J', descricao: '' },
    { categoria: 'casamento', url: 'https://drive.google.com/uc?export=view&id=17uPMEf1fRxM7e52dwrgreUvVzReYfDjq', titulo: 'Casamento A&J', descricao: '' },
    { categoria: 'casamento', url: 'https://drive.google.com/uc?export=view&id=1OUpBQLhAqFB-D-0H_cu0SFegyjpJ2K3J', titulo: 'Casamento A&J', descricao: '' },
